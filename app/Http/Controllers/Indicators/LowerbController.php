...
class LowerbController extends Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->table = 'lowerb_indicator';
        $this->indicatorName = 'bbands';
        $this->responseAttr = 'lowerband';
        $this->columnName = 'lowerband';
        $this->timeperiod = 3;
    }
    ...
    public function getIndicator($symbol)
    {
        ...
        $indicatorResponseAttr = $indicatorResponse->original[$this->indicatorName] ?? null;
