...
class StockUnlimitedScreenerController extends Controller
{
    /**
    ...
    public function getScreenerResult(Request $request)
    {
        ...
        $per_page = $request->input('per_page', 4000);
...
'stock_symbols.id', '=', 'latest_stock_company_earnings_quality_score.stock_id')
    ...
    ->whereNotIn('stocks_by_market_cap.symbol', [
        'ALTM', 'ALTR', 'AZPN', 'EDR', 'FNA', 'HCP', 'INFN', 'ITCI', 'MTTR', 'NARI', 'NVEE', 'PTVE', 'SASR'
    ])
    ...
    ->where('stock_symbol_info.industry', '!=', '');    
        ...
        $cacheKey = 'stocks_result22_'.md5(json_encode([
            'ssector'=> $stock_sector,
